...
const ResultScreen = ({route}) => {
    ...
    const description = Description[prediction];

    const nutritionalInfo = Nutrition[prediction];

    return (
        <View style={styles.container}>
            <Text style={styles.result}>Result</Text>
            <View style={styles.predictedName}>
                <Text style={styles.predDishName}>Predicted dish name</Text>
            ...
            <View style={styles.nutriinfo}>
                <Text style={styles.nutriinfotext}>Nutritional Information</Text>
                <Text style={styles.nutriinfovalue}>Calories {nutritionalInfo.Calories}</Text>
                <Text style={styles.nutriinfovalue}>Fat {nutritionalInfo.Fat}</Text>
                <Text style={styles.nutriinfovalue}>Protein {nutritionalInfo.Protein}</Text>
                <Text style={styles.nutriinfovalue}>Carbohydrates {nutritionalInfo.Carbohydrates}</Text>
                <Text style={styles.nutriinfovalue}>Fiber {nutritionalInfo.Fiber}</Text>
            </View>
        </View>
    )
}
